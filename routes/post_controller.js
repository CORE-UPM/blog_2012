...
exports.search = function(req, res, next) {
    console.log("Estamos buscando posts que contengan: " + req.query.search.replace(/ /g,"%"));
    var bqd = "%"+req.query.search.replace(/ /g,"%")+"%";

    models.Post
        .findAll({where:["title like ? OR body like?", bqd, bqd], order: 'updatedAt DESC'})
        .success(function(posts) {
        ...
        .error(function(error) {
            console.log("Error: No puedo listar los posts buscados.");
            res.redirect('/');
        });
};
